...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/rizaddin/perizinan/main/ipvps.txt | grep $MYIP )
if [ $MYIP = $MYIP ]; then
...
echo -e "${NC}${LIGHT}WhatsApp : 081329322508"
echo -e "${NC}${LIGHT}Telegram : https://t.me/dilanjaya"
exit 0
fi
# ==================================================
# Link Hosting Kalian
