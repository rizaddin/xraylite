...
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/rizaddin/xraylite/main/Insshws/password.txt"
...
cd
cd
wget -O /usr/bin/badvpn-udpgw https://raw.githubusercontent.com/rizaddin/xraylite/main/udpgw/badvpn-udpgw && chmod +x  /usr/bin/badvpn-udpgw
#system badvpn 7300
wget -O /etc/systemd/system/svr-7300.service https://raw.githubusercontent.com/rizaddin/xraylite/main/udpgw/svr-7300.service && chmod +x  /etc/systemd/system/svr-7300.service
#system badvpn 7200
wget -O /etc/systemd/system/svr-7200.service https://raw.githubusercontent.com/rizaddin/xraylite/main/udpgw/svr-7200.service && chmod +x  /etc/systemd/system/svr-7200.service
#system badvpn 7100
wget -O /etc/systemd/system/svr-7100.service https://raw.githubusercontent.com/rizaddin/xraylite/main/udpgw/svr-7100.service && chmod +x  /etc/systemd/system/svr-7100.service
